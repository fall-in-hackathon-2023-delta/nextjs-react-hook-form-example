...
function Form() {
 ...
 useEffect(() => {
  ...
  return <form onSubmit={handleSubmit(onSuccess, onError)}>
    <Requirement.Container type={"myTodos"} fields={fields} />
      
    <Requirement.Container type={"pendingTodos"} fields={fields} />

    <Requirement.Container type={"todos"} fields={fields} />

    <Requirement.Container type={"completedTodos"} fields={fields} />
